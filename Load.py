...
Ideas:
2d orbit calculator
	plot after each burn
	calculate delta-V each burn
	check for spheres of influence

include limited telemetry and orbit prediction, maybe a range of orbits
start with earth and moon
make up planets and moons

Craft options:
	rocket price based on size
	design and research costs & time

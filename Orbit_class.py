...
class State:
    ...
    def kinetic(self):
        """Kinetic Energy (for calculations)"""
        return 0.5 * self.speed ** 2

    def potential(self):
        """Potential Energy (for calculations)"""
    ...
    def get_orbit(self):
        ...
        k2 = self.r * self.speed ** 2 / 2.0 - 2.0  # r / semi
...
test_orbit_dict = {'mu': 547e6,
                   'peri': 20e3,
                   'ecc': 0.234,
                   't0': 0.0,
                   'lop': 0.0}

test_orbit = mk_Orbit(test_orbit_dict)
